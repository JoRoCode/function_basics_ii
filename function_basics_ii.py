...
print(first_plus_length([287,43,26,99,78,24,146,39,29,11,60,42]))
...
print(values_greater_than_second([12,9,7,14,8,5,23,44,6,9]))
...
def length_and_value(list_len, list_val):
    for i in range(list_len):
        new_list.append(list_val)
    return new_list

print(length_and_value(37,24))
